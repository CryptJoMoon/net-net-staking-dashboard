...
function App() {
  ...
  return <main className="desktop"><div className="frame">
    ...
    <div className="stats">
      ...
      <Readout icon={Coins} label="WinNET PrizeVault balance" value={`${amount(venueStake.winNet, 2)} sNET`} sub={`${winNetParticipants.toLocaleString()} active principal wallets${fund?.playingTonight != null ? ` · ${fund.playingTonight.toLocaleString()} playing tonight` : ''}`} />
